// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Directory/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *DirectoryZone) Create(ctx context.Context, field_list []string) (*DirectoryZone, error) {
	err := object.cinp.Create(ctx, "/api/v1/Directory/Zone", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *DirectoryZone) Update(ctx context.Context, field_list []string) (*DirectoryZone, error) {
...
// NOTE: the object will be updated with values from the server
func (object *DirectoryEntry) Create(ctx context.Context, field_list []string) (*DirectoryEntry, error) {
	err := object.cinp.Create(ctx, "/api/v1/Directory/Entry", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *DirectoryEntry) Update(ctx context.Context, field_list []string) (*DirectoryEntry, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

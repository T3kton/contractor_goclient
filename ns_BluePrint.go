// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/BluePrint/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *BlueprintFoundationBluePrint) Create(ctx context.Context, field_list []string) (*BlueprintFoundationBluePrint, error) {
	err := object.cinp.Create(ctx, "/api/v1/BluePrint/FoundationBluePrint", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintFoundationBluePrint) Update(ctx context.Context, field_list []string) (*BlueprintFoundationBluePrint, error) {
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintStructureBluePrint) Create(ctx context.Context, field_list []string) (*BlueprintStructureBluePrint, error) {
	err := object.cinp.Create(ctx, "/api/v1/BluePrint/StructureBluePrint", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintStructureBluePrint) Update(ctx context.Context, field_list []string) (*BlueprintStructureBluePrint, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintScript) Create(ctx context.Context, field_list []string) (*BlueprintScript, error) {
	err := object.cinp.Create(ctx, "/api/v1/BluePrint/Script", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintScript) Update(ctx context.Context, field_list []string) (*BlueprintScript, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintBluePrintScript) Create(ctx context.Context, field_list []string) (*BlueprintBluePrintScript, error) {
	err := object.cinp.Create(ctx, "/api/v1/BluePrint/BluePrintScript", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintBluePrintScript) Update(ctx context.Context, field_list []string) (*BlueprintBluePrintScript, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintPXE) Create(ctx context.Context, field_list []string) (*BlueprintPXE, error) {
	err := object.cinp.Create(ctx, "/api/v1/BluePrint/PXE", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BlueprintPXE) Update(ctx context.Context, field_list []string) (*BlueprintPXE, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Building/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *BuildingFoundation) Update(ctx context.Context, field_list []string) (*BuildingFoundation, error) {
...
// NOTE: the object will be updated with values from the server
func (object *BuildingStructure) Create(ctx context.Context, field_list []string) (*BuildingStructure, error) {
	err := object.cinp.Create(ctx, "/api/v1/Building/Structure", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingStructure) Update(ctx context.Context, field_list []string) (*BuildingStructure, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingComplex) Create(ctx context.Context, field_list []string) (*BuildingComplex, error) {
	err := object.cinp.Create(ctx, "/api/v1/Building/Complex", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingComplex) Update(ctx context.Context, field_list []string) (*BuildingComplex, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingComplexStructure) Create(ctx context.Context, field_list []string) (*BuildingComplexStructure, error) {
	err := object.cinp.Create(ctx, "/api/v1/Building/ComplexStructure", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingComplexStructure) Update(ctx context.Context, field_list []string) (*BuildingComplexStructure, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingDependency) Create(ctx context.Context, field_list []string) (*BuildingDependency, error) {
	err := object.cinp.Create(ctx, "/api/v1/Building/Dependency", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *BuildingDependency) Update(ctx context.Context, field_list []string) (*BuildingDependency, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/IPMI/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *IpmiIPMIFoundation) Create(ctx context.Context, field_list []string) (*IpmiIPMIFoundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/IPMI/IPMIFoundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *IpmiIPMIFoundation) Update(ctx context.Context, field_list []string) (*IpmiIPMIFoundation, error) {

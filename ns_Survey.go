// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Survey/ at 2026-01-08T06:07:57.779085+00:00
package contractor
...
func (object *SurveyPlot) Create(ctx context.Context) error {
	err := object.cinp.Create(ctx, "/api/v1/Survey/Plot", object)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *SurveyPlot) Update(ctx context.Context) error {

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/VirtualBox/ at 2025-09-11T17:24:39.658403
/*
...
func (object *VirtualboxVirtualBoxComplex) Create(ctx context.Context, field_list []string) (*VirtualboxVirtualBoxComplex, error) {
	err := object.cinp.Create(ctx, "/api/v1/VirtualBox/VirtualBoxComplex", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *VirtualboxVirtualBoxComplex) Update(ctx context.Context, field_list []string) (*VirtualboxVirtualBoxComplex, error) {
...
// NOTE: the object will be updated with values from the server
func (object *VirtualboxVirtualBoxFoundation) Create(ctx context.Context, field_list []string) (*VirtualboxVirtualBoxFoundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/VirtualBox/VirtualBoxFoundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *VirtualboxVirtualBoxFoundation) Update(ctx context.Context, field_list []string) (*VirtualboxVirtualBoxFoundation, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Foreman/ at 2026-08-11T23:43:36.858582+00:00
package contractor
...
/*
BaseJob(id, site, state, status, message, note, script_runner, script_name, updated, created)
*/
...
/*
FoundationJob(id, site, state, status, message, note, script_runner, script_name, updated, created, basejob_ptr, foundation)
*/
...
/*
StructureJob(id, site, state, status, message, note, script_runner, script_name, updated, created, basejob_ptr, structure)
*/
...
/*
DependencyJob(id, site, state, status, message, note, script_runner, script_name, updated, created, basejob_ptr, dependency)
*/

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/Azure/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *AzureAzureComplex) Create(ctx context.Context, field_list []string) (*AzureAzureComplex, error) {
	err := object.cinp.Create(ctx, "/api/v1/Azure/AzureComplex", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *AzureAzureComplex) Update(ctx context.Context, field_list []string) (*AzureAzureComplex, error) {
...
// NOTE: the object will be updated with values from the server
func (object *AzureAzureFoundation) Create(ctx context.Context, field_list []string) (*AzureAzureFoundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/Azure/AzureFoundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *AzureAzureFoundation) Update(ctx context.Context, field_list []string) (*AzureAzureFoundation, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/VCenter/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *VcenterVCenterComplex) Create(ctx context.Context, field_list []string) (*VcenterVCenterComplex, error) {
	err := object.cinp.Create(ctx, "/api/v1/VCenter/VCenterComplex", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *VcenterVCenterComplex) Update(ctx context.Context, field_list []string) (*VcenterVCenterComplex, error) {
...
// NOTE: the object will be updated with values from the server
func (object *VcenterVCenterFoundation) Create(ctx context.Context, field_list []string) (*VcenterVCenterFoundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/VCenter/VCenterFoundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *VcenterVCenterFoundation) Update(ctx context.Context, field_list []string) (*VcenterVCenterFoundation, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

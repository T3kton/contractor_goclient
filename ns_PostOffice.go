// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/PostOffice/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *PostofficeFoundationBox) Create(ctx context.Context, field_list []string) (*PostofficeFoundationBox, error) {
	err := object.cinp.Create(ctx, "/api/v1/PostOffice/FoundationBox", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *PostofficeFoundationBox) Update(ctx context.Context, field_list []string) (*PostofficeFoundationBox, error) {
...
// NOTE: the object will be updated with values from the server
func (object *PostofficeStructureBox) Create(ctx context.Context, field_list []string) (*PostofficeStructureBox, error) {
	err := object.cinp.Create(ctx, "/api/v1/PostOffice/StructureBox", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *PostofficeStructureBox) Update(ctx context.Context, field_list []string) (*PostofficeStructureBox, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

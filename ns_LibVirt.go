// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/LibVirt/ at 2025-09-11T17:24:39.658403
/*
...
func (object *LibvirtLibVirtComplex) Create(ctx context.Context, field_list []string) (*LibvirtLibVirtComplex, error) {
	err := object.cinp.Create(ctx, "/api/v1/LibVirt/LibVirtComplex", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *LibvirtLibVirtComplex) Update(ctx context.Context, field_list []string) (*LibvirtLibVirtComplex, error) {
...
// NOTE: the object will be updated with values from the server
func (object *LibvirtLibVirtFoundation) Create(ctx context.Context, field_list []string) (*LibvirtLibVirtFoundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/LibVirt/LibVirtFoundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *LibvirtLibVirtFoundation) Update(ctx context.Context, field_list []string) (*LibvirtLibVirtFoundation, error) {
	err := object.cinp.Update(ctx, object, field_list)
	if err != nil {
		return nil, err
	}

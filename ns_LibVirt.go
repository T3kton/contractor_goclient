// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/LibVirt/ at 2026-08-21T02:15:33.391106+00:00
/*
...
type LibvirtLibVirtFoundation struct {
	...
	LibvirtConsoleType *string                 `json:"libvirt_console_type,omitempty"`
	State              *string                 `json:"state,omitempty"`
	Type               *string                 `json:"type,omitempty"`

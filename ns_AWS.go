// Package contractor - (version: "0.1") - Automatically generated by cinp-codegen from /api/v1/AWS/ at 2025-09-11T17:24:39.658403
package contractor
...
func (object *AwsAWSEC2Foundation) Create(ctx context.Context, field_list []string) (*AwsAWSEC2Foundation, error) {
	err := object.cinp.Create(ctx, "/api/v1/AWS/AWSEC2Foundation", object, field_list)
	if err != nil {
		return err
	}
...
// NOTE: the object will be updated with values from the server
func (object *AwsAWSEC2Foundation) Update(ctx context.Context, field_list []string) (*AwsAWSEC2Foundation, error) {
